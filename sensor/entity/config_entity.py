...
class DataIngestionConfig:            # For Stage 1: Data Ingestion
...
class DataValidationConfig:          # For Stage 2: Data Validation
...
class DataTransformationConfig:              # For Stage 3: Data Transformation
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
...
class ModelTrainerConfig:                   # For Stage 4: Model Trainer
...
class ModelEvaluationConfig:                # For Model Evaluation
...
class ModelPusherConfig:                    # For Stage 5: Model Pusher
