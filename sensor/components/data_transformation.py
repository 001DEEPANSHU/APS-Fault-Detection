...
class DataTransformation:
    ...
    def get_data_transformer_object(cls)->Pipeline:
        try:
            ...
            simple_imputer = SimpleImputer(strategy="constant", fill_value=0) #Fill missing values with 0
    ...
    def initiate_data_transformation(self,) -> DataTransformationArtifact:
        ...
        try:    
            ...
            smt = SMOTETomek(sampling_strategy="minority") # Handling imbalanced data
